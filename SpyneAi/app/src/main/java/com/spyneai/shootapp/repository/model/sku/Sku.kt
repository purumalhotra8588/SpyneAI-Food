...
class Sku(
    ...
    var toProcessAt: Long = System.currentTimeMillis(),
    val retryCount: Int = 1,
    val threeSixtyList: List<String>? = null,
    var environment: String? = null,
    @SerializedName("image_upload_type")
    val shootType: String? = null,
    var processDataMap: HashMap<String, Any>? = null,
    var credits: Credits? = null,
    var processSku: Boolean = false,
