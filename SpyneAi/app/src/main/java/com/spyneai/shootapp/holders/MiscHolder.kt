...
class MiscHolder(
...
) : RecyclerView.ViewHolder(itemView), GenericAdapter.Binder<CatAgnosticResV2.CategoryAgnos.Miscellaneou>{
    ...
    override fun bind(data: CatAgnosticResV2.CategoryAgnos.Miscellaneou) {
