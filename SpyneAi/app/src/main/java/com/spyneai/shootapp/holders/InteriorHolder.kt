...
class InteriorHolder(
...
) : RecyclerView.ViewHolder(itemView), GenericAdapter.Binder<CatAgnosticResV2.CategoryAgnos.Interior>{
    ...
    override fun bind(data: CatAgnosticResV2.CategoryAgnos.Interior) {
