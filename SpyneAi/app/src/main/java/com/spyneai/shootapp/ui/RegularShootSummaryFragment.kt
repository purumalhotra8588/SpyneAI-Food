...
class RegularShootSummaryFragment  : BaseFragment<ProcessViewModelApp, FragmentRegularShootSummaryBinding>(),View.OnTouchListener {
...
//        observeCredits()
        ...
        binding.tvSkuId.text = viewModel.skuApp?.skuId
    ...
    private fun reduceCredits(showLoader : Boolean) {
        ...
        viewModel.reduceCredit(
            ...
            viewModel.skuApp?.skuId.toString()
        )
    }
        ...
        requireContext().captureEvent(
            ...
            HashMap<String, Any?>()
                .apply {
                    ...
                    this.put("background_id", viewModel.backgroundAppSelect)
                }
