...
//        val strNumber = intent.getStringExtra(AppConstants.phone)!!
        ...
        tvNumber.text = Utilities.getPreference(this,AppConstants.EMAIL_ID)
    ...
    private fun postOtp(otpEntered: String) {
        ...
        call?.enqueue(object : Callback<OtpResponse> {
            override fun onResponse(call: Call<OtpResponse>, response: Response<OtpResponse>) {
                ...
                if (response.isSuccessful ) {
                    ...
                    if (otpResponse?.status == 200) {
                        ...
                        Utilities.savePrefrence(this@OtpActivity, AppConstants.USER_ID, response.body()!!.userId)
            ...
            override fun onFailure(call: Call<OtpResponse>, t: Throwable) {
                captureFailureEvent(Events.OTP_VERIFICATION_FAILED,HashMap<String,Any?>(),t?.localizedMessage.toString())
                Toast.makeText(this@OtpActivity, "Server not responding!!!", Toast.LENGTH_SHORT).show()
                Utilities.hideProgressDialog()
    ...
    private fun resendOtp(phoneNumber: String) {
        ...
        call?.enqueue(object : Callback<LoginResponse>{
            ...
            override fun onFailure(call: Call<LoginResponse>, t: Throwable) {
                captureFailureEvent(Events.OTP_RESENT_FAILED,HashMap<String,Any?>(),t?.localizedMessage.toString())
                Utilities.hideProgressDialog()
                Toast.makeText(
                    this@OtpActivity,
