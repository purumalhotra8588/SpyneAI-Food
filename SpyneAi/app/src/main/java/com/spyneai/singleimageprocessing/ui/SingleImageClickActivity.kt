...
import com.spyneai.databinding.ActivitySingleImageClickBinding
import com.spyneai.needs.AppConstants
import com.spyneai.needs.Utilities
import com.spyneai.singleimageprocessing.data.SingleImageViewModel

class SingleImageClickActivity : AppCompatActivity() {
    lateinit var binding : ActivitySingleImageClickBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySingleImageClickBinding.inflate(layoutInflater)
