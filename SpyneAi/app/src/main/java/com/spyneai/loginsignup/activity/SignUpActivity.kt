...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       ivSignUpShowPassword.setOnClickListener {
            if(!showPassword){
                et_signupPassword.inputType = InputType.TYPE_CLASS_TEXT or InputType.TYPE_CLASS_TEXT
                showPassword=true
                ivSignUpShowPassword.setColorFilter(ContextCompat.getColor(this, R.color.primary))
                et_signupPassword.setText(et_signupPassword.text.toString())
            }else{
                et_signupPassword.inputType = InputType.TYPE_CLASS_TEXT or InputType.TYPE_TEXT_VARIATION_PASSWORD
                showPassword=false
                ivSignUpShowPassword.setColorFilter(ContextCompat.getColor(this, R.color.eye_grey))
                et_signupPassword.setText(et_signupPassword.text.toString())
    ...
    private fun signUp(email: String, password: String, name: String, country: String,coupon: String) {
        ...
        call?.enqueue(object : Callback<SignupResponse> {
            ...
            override fun onFailure(call: Call<SignupResponse>, t: Throwable) {
                ...
                captureFailureEvent(Events.SIGNUP_FAILED, properties, t?.localizedMessage.toString())
            }
        })
    }
}