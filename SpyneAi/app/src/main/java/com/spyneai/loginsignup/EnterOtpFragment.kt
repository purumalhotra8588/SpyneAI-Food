...
import com.spyneai.loginsignup.data.MySMSBroadcastReceiver
import com.spyneai.loginsignup.data.OnBoardingViewModel
...
//                        )
//                    } else {
                    val intent = Intent(requireContext(), ChooseRIDActivity::class.java)
                    intent.flags =
