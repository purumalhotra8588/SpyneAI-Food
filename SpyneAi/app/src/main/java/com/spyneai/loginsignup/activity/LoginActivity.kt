...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.ivShowPassword.setOnClickListener {
            if(!showPassword){
                binding.etLoginPassword.inputType = InputType.TYPE_CLASS_TEXT or InputType.TYPE_CLASS_TEXT
                showPassword=true
                ...
                showPassword=false
                binding.ivShowPassword.setColorFilter(ContextCompat.getColor(this, R.color.eye_grey))
                binding.etLoginPassword.setText(binding.etLoginPassword.text.toString())
    ...
    private fun login(email: String, password: String) {
        ...
        call?.enqueue(object : Callback<LoginEmailPasswordResponse> {
            ...
            override fun onFailure(call: Call<LoginEmailPasswordResponse>, t: Throwable) {
                Utilities.hideProgressDialog()
                captureFailureEvent(Events.LOGIN_FAILED,properties,t?.localizedMessage.toString())
                Toast.makeText(
                    applicationContext,
