...
public class CategoriesAdapter(
    val context: Context,
    val categoriesResponseList: ArrayList<CatAgnosticResV2.CategoryAgnos>,
...
*/
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.tvCategoryName.text = categoriesResponseList[position].name
        ...
        if (categoriesResponseList[position].isActive){
            viewHolder.llCategories.alpha = 1.0F
        }else{
