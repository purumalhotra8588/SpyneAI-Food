...
object AppConstants {
    ...
    val IMAGE_ID_FOOD = "IMAGE_ID_FOOD"
    val ENABLE_BEFORE = "ENABLE_BEFORE"
    val ENABLE_AFTER = "ENABLE_AFTER"
    val CAPTURED_IMAGE = "CAPTURED_IMAGE"
    val USER_NAME_EIDTED = "USER_NAME_EIDTED"
    val NEW_LOGIN_API = "NEW_LOGIN_API"
    val TEAM_ID = "TEAM_ID"
    val LOGIN_UUID = "LOGIN_UUID"
    val TEAM_NAME = "TEAM_NAME"
    val ENTERPRISE_NAME = "ENTERPRISE_NAME"
    val RESOURCE_TYPE = "RESOURCE_TYPE"
    val MOBILE_NUMBER ="MOBILE_NUMBER"
    val COUNTOCR = "Count_ocr"
    val ADD_HOTSPOT_DIALOG_COUNT = "add_count"
    val VEHICLEID = "VEHICLE_ID"
    val USER_NAME_NEW = "USER_NAME"
    val COMPANY_NAME = "company_name"
    val COLOR_OCR = "color"
    val NAME_OF_OWNER = "NAME_OF_OWNER"
    val CHASSIS_OCR = "Chasis_OCR"
    val ENGINE_OCR = "ENGINE_OCR"
    val MODEL_OCR = "MODEL_OCR"
    val ODOMETER_OCR = "ODOMETER_OCR"
    var REGISTRATION_NUMBER ="REGISTRATION_NUMBER"
    var ODONUMBER ="Registration_Number"
    val PRESSED_LOGOUT = "pressed_logout"
    val UPLOAD_URL = "UPLOAD_URL"
    val FROM_SELECTION = "FROM_SELECTION"
    val PROCESS_IMAGE = "PROCESS_IMAGE"
    val IMAGE_ANGLE = "IMAGE_ANGLE"
    val IMAGE_NAME = "IMAGE_NAME"
    val LAST_PROCESSED_IMAGE = "LAST_PROCESSED_IMAGE"
    val SELECTED_CATEGORY_ORIENTATION = "SELECTED_CATEGORY_ORIENTATION"
    val SELECTED_CATEGORY_ID = "SELECTED_CATEGORY"
    val SUBMIT_PROJECT_TRIGGERED = "SUBMIT_PROJECT_TRIGGERED"
    val ORIENTATION = "ORIENTATION"
    val IS_ADD_IMAGE = "IS_ADD_IMAGE"
    val BACKGROUND_ID = "BACKGROUND_ID"
    val CHECK_QC = "CHECK_QC"
    val ENTITY_NAME = "ENTITY_NAME"
    val SHOW_MARKETPLACES = "SHOW_MARKETPLACES"
    val ID = "ID"
    val RESEND_OTP = "RESEND_OTP"
    ...
    val KARVInew_ENTERPRISE_ID: String = "DaD1JC1Fp"
...
//        var SIGNUP_URL : String = "https://console.spyne.ai/register"
    ...
    val FILTER_AISCORE_SELECTED: String = "FILTER_AISCORE_SELECTED"
    val FILTER_IMAGE_RATING_SELECTED: String = "FILTER_IMAGE_RATING_SELECTED"
    val FILTER_DATE_SELECTED: String = "FILTER_DATE_SELECTED"
    val FILTER_ALPHABETICAL_SELECTED: String = "FILTER_ALPHABETICAL_SELECTED"
    val FILTER_AUTOMOBILE_SELECTED: String = "FILTER_AUTOMOBILE_SELECTED"
    ...
    val WOMENS_FASHION_WM_CATEGORY_ID = "cat_qhq134CNm5"
    ...
    val IS_UPLOAD_FLOW = "IS_UPLOAD_FLOW"
    ...
    val EMAIL_ID_REG_: String = "email_id_reg"
    ...
    const val BASE_IMAGE_URL2 = "https://spyne-static.s3.amazonaws.com"

    val shootEvn = "shoot_evn"
    val is360="is360"
    val TINT_WINDOW="tintWindow"
    val TINT_TYPE="tintType"
    ...
    val CREDITS_USER: String = "credits_user"
    ...
    val ENTERPRISE_CODE: String = "enterpriseCode"
    val USER_CATEGORY: String = "userCategory"
    val USER_EMAIL: String = "userEmail"

    val VIDEO_URL: String = "videoUrl"

    val IS_NEW_USER: String = "isNewUser"
    val USER_ENTERPRISE: String = "USER ENTERPRISE"
    val NEW_ENTERPRISE_USER: String = "NEW ENTERPRISE USER"
    val USER_ROLE: String = "USER_ROLE"


    val SHOOT_TYPE: String = "SHOOT_TYPE"
    val FROM_SDK: String = "FROM_SDK"
    ...
    val WALMART = "Spyne for Walmart"
    val SPYNE_AI_AUTOMOBILE = "SpyneAI Automobile"
    val SPYNE_AI_ECOM = "Spyne Ecommerce"
    ...
    val CATAGNOSTAG = "CategoryDataDao"

    val ENTERPRISE_DISCOUNT = "ENTERPRISE DISCOUNT"

    val PRICE_PER_CREDIT = "PRICE PER CREDIT"

    val COACH_MARKS = "COACH MARKS"

    val CREDIT_DEFICIETS = "CREDIT DEFICITS"
    val CREDIT_BALANCE = "CREDIT BALANCE"
    var IS_NERF_AVAILABLE = false
    val SHOW_EDITED_ONLY = "SHOW_EDITED_ONLY"
    val VIDEO_IMAGES= "VIDEO_IMAGES"
    val SELECTED_SUBCAT_ID = "SELECTED_SUBCAT_ID"

    val FETCH_PROJECT_LIMIT_HOME = 3
    val FETCH_PROJECT_LIMIT = 5
}